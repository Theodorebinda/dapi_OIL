...
import { Truck, ShieldCheck, Warehouse, Headphones, Award, Users, Leaf, ArrowRight } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <h1 className="font-display font-bold text-4xl md:text-6xl mb-6">
              Moteur du développement <span className="text-gold-500">congolais</span>
            </h1>
            <p className="text-xl text-gray-300 leading-relaxed">
              Une expertise locale pour une distribution sans faille à travers la RDC.
              Nous transformons les défis logistiques en opportunités de croissance.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <div className="space-y-6 text-gray-300 text-lg leading-relaxed">
                <p>
                  Dans un pays aux dimensions continentales, l'énergie est le sang qui irrigue l'économie.
                  Notre mission est d'assurer l'approvisionnement ininterrompu des industries minières, 
                  des infrastructures publiques et des ménages, de Kinshasa aux provinces les plus reculées.
                </p>
                <p>
                  Nous ne nous contentons pas de transporter du carburant ; nous apportons la fiabilité 
                  nécessaire au fonctionnement des hôpitaux, des usines et des transports en commun.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Une maîtrise technique et logistique adaptée aux défis uniques de la République Démocratique du Congo.
            </p>
          </div>
      ...
      <section className="py-20 bg-petrol-900 border-y border-white/5">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Intégrité', icon: Award, text: 'La transparence totale dans nos transactions commerciales et nos relations avec l\'État.' },
              { title: 'Sécurité (HSE)', icon: Users, text: 'Zéro compromis sur la sécurité de nos employés et des communautés que nous traversons.' },
              { title: 'Innovation Locale', icon: Leaf, text: 'Adapter les technologies mondiales aux réalités du terrain congolais.' },
            ].map((val, idx) => (
              <motion.div
                key={idx}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-3xl mx-auto text-center p-12 rounded-3xl bg-gradient-to-br from-petrol-800 to-petrol-900 border border-white/10 shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-display font-bold mb-6">Prêt à sécuriser votre approvisionnement ?</h2>
            <p className="text-gray-300 mb-8 text-lg">
              Rejoignez les plus grandes industries de RDC qui font confiance à Congo Energy Logistics.
            </p>
