...
export const FeatureCard = ({
  ...
  return (
    ...
    >
      <div className="absolute -mr-16 -mt-16 right-0 top-0 rounded-full bg-[rgb(var(--bg-rgb)/0.08)] p-32 blur-3xl transition-all group-hover:bg-[rgb(var(--bg-rgb)/0.16)]" />
      ...
      <div className="relative z-10 flex h-full flex-col items-start">
        ...
        <p className="text-sm leading-relaxed text-[rgb(var(--text-rgb)/0.75)]">{description}</p>
      </div>
    </motion.div>
  );
};
